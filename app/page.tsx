...
export default function Page() {
  const [state, setState] = useState<AuthFormState>(DEFAULT_AUTHFORM_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Auth Form Studio" controls={controls} preview={output} /></AppShell>;
}
