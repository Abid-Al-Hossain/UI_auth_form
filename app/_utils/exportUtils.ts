...
export function buildReactCode(state: AuthFormState) {
  return [
    ...
    "  const inputStyle = { width: \"100%\", border: \"1px solid \" + (isError ? \"#ef4444\" : state.border), borderRadius: Math.max(10, state.radius - 12), background: \"rgba(255,255,255,.08)\", color: state.foreground, padding: \"11px 13px\", outline: \"none\" };",
    "",
    "  return (",
