...
export default function TypographySection({ state, update }: Props) {
  return <SectionCard title="Typography" subtitle="Typography controls for native auth generation."><FontFamilySelect value={state.fontFamily} onChange={(value) => update("fontFamily", value)} />
