# UI Foundry Auth Form Studio

Standalone visual Auth Form generator built with Next.js, React, and TypeScript.

Standalone Auth Form component studio for building native, preview-honest, React-exportable UI patterns that match the UI Foundry product line.
...
- designers building Auth Form UI quickly
- developers who need editable React starting points
- marketplace buyers who want a self-contained Auth Form generator
...
The editor is focused on controls that are native to Auth Form and useful in real product work:
- login/register/reset intent, email/password fields, remember me, actions, social slots, and validation messages
- field metadata, helper/error/success, disabled/loading, password reveal, and form state preview
- surface, layout, typography, spacing, color, radius, border, and shadow
- form accessibility and native attribute expectations
- React export for auth form composition

The goal is maximum useful depth without adding unrelated controls that would make the component stop reading as Auth Form.
...
This repo is intended to publish as Abid-Al-Hossain/UI_auth_form.
